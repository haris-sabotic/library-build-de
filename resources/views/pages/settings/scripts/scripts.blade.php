    ...
    @can('isAdmin')
        <section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
            ...
            <div class="py-4 text-gray-500 border-b-[1px] border-[#e4dfdf] pl-[30px]">
                ...
                <a href="{{route('scripts')}}" class="inline ml-[70px] hover:text-blue-800 active-book-nav">
                    Pismo
                </a>
            </div>
                    ...
                    <table class="min-w-full shadow-lg" id="myTable">
                        <thead class="bg-[#EFF3F6]">
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <th class="p-4 leading-4 tracking-wider text-left whitespace-nowrap">Naziv pisma<a href="#"><i
                        ...
                        @foreach($scripts as $script)
                                ...
                                <td class="p-4 text-sm leading-5 text-right">
                                    ...
                                    <div
                                        ...
                                        <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                <a href="{{route('editScript', ['script' => $script->id])}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                    <i class="fas fa-edit mr-[1px] ml-[5px] py-1"></i>
                                                    <span class="px-4 py-0">Izmijeni pismo</span>
                                                </a>
                                                <a href="#" tabindex="0" id="{{$script->id}}"
                            ...
                            <!--Modal-->
                            <div
                                class="absolute z-20 top-0 left-0 items-center justify-center hidden w-full h-screen bg-black bg-opacity-10 delete-modal_{{$script->id}}" id="{{$script->id}}">
                                <!-- Modal -->
                                <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
                                    ...
                                    <div class="flex items-center justify-center px-[30px] py-[20px] border-t w-100 text-white">
                                        <a href="{{route('deleteScript', ['script' => $script->id])}}"
                ...
                @else
                    <div class="mx-[50px]">
                        <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-red-200 rounded-lg">                       
                            ...
                            <p class="font-medium text-red-600"> Ne postoji nijedno pismo u bazi podataka! </p>
                        </div>
                    </div>   
                @endif
            </div>
