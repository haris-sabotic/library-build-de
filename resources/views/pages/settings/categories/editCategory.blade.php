...
@section('editCategory')
    ...
    <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
                        ...
                        <div>
                            <nav class="w-full rounded">
                                <ol class="flex list-reset">
                                    ...
                                    <li>
                                        <a href="{{route('categories')}}" class="text-[#2196f3] hover:text-blue-600">
                                            Kategorije
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('editCategory', ['category' => $category]) }}" class="text-gray-400 hover:text-blue-600">
                                            Izmijeni kategoriju
                                        </a>
                                    </li>
                                </ol>
            ...
            <div class="scroll height-content section-content">
                <form action="{{route('updateCategory', ['category' => $category])}}" method="POST" enctype="multipart/form-data" class="text-gray-700">
                @csrf
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[100px]">
                            <div class="mt-[20px]">
                                <p>Naziv kategorije <span class="text-red-500">*</span></p>
                                <input type="text" name="categoryNameEdit" id="categoryNameEdit" value="{{$category->name}}"
                                    class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]"/>
                                    @error('categoryNameEdit')
                            ...
                            <div class="mt-[20px]">
                                ...
                                <textarea name="categoryDescriptionEdit" rows="10"
                                    class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]">
                                    {{$category->description}}
                                </textarea>
                                @error('categoryDescriptionEdit')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="absolute bottom-0 w-full">
                        <div class="flex flex-row">
                            <div class="inline-block w-full text-white text-right py-[7px] mr-[100px]">
                                ...
                                <button id="editCategory" type="submit"
