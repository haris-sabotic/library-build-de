    ...
    @can('isAdmin')
        ...
        @if(count($librarians) > 0)
            <div class="scroll height-dashboard">
                <div class="flex items-center justify-between px-[30px] py-4 space-x-3 rounded-lg">
                    <a href="addLibrarian" class="btn-animation text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] whitespace-nowrap">
                        <i class="fas fa-plus mr-[15px]"></i> Novi bibliotekar
                    </a>
                    <form action="searchLibrarians" method="GET">
                        <div class="flex items-center pl-6 py-4 space-x-3 rounded-lg ml-[292px]">
                            <div class="flex items-center">
                                <div class="relative text-gray-600 focus-within:text-gray-400">
                                    ...
                                    <input type="search" name="searchLibrarians"
                ...
                <div
                    ...
                    <table class="min-w-full shadow-lg" id="myTable">
                        ...
                        <tr class="border-b-[1px] border-[#e4dfdf]">
                            ...
                            <th class="p-4 leading-4 tracking-wider text-left whitespace-nowrap">Ime i prezime<a href="#"><i
                                        class="ml-3 fa-lg fas fa-long-arrow-alt-down" onclick="sortTable()"></i></a>
                            </th>
                            <th class="p-4 text-sm leading-4 tracking-wider text-left">E-mail</th>
                            <th class="p-4 text-sm leading-4 tracking-wider text-left whitespace-nowrap">Tip korisnika</th>
                            <th class="p-4 text-sm leading-4 tracking-wider text-left whitespace-nowrap">Zadnji pristup sistemu
                            </th>
                            <th class="p-4"> </th>
                        </tr>
                        </thead>
                        ...
                        <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                            ...
                            <td class="flex flex-row items-center p-4 whitespace-nowrap">
                                <img class="object-cover w-8 h-8 mr-4 rounded-full" src="/storage/image/{{$user->photo}}"
                                    alt="" />
                                <a href="{{ route('librarianProfile', ['user' => $user->id]) }}">
                                    <span class="font-medium text-center">
                                        {{ $user -> name }}
                                    </span>
                                </a>
                            </td>
                            <td class="p-4 text-sm leading-5 whitespace-nowrap">{{ $user -> email }}
                            </td>
                            ...
                            <td class="p-4 text-sm leading-5 text-right whitespace-nowrap">
                                <p class="inline cursor-pointer text-[20px] py-[10px] px-[10px] 2xl:px-[30px] border-gray-300 dotsLibrarian hover:text-[#606FC7]">
                                ...
                                <div
                                    ...
                                    <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                        ...
                                        <div class="py-1">
                                            <a href="{{ route('librarianProfile', ['user' => $user->id]) }}" tabindex="0"
                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                            role="menuitem">
                                                <i class="far fa-file mr-[5px] ml-[5px] py-1"></i>
                                                <span class="px-4 py-0">Pogledaj detalje</span>
                                            </a>
                                            <a href="{{ route('editLibrarian', ['user' => $user->id]) }}" tabindex="0"
                                            class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                            role="menuitem">
        ...
        @else
            <div class="mx-[20px] mt-[20px]">
                    <a href="{{route('addLibrarian')}}" class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE]">
                        <i class="fas fa-plus mr-[15px]"></i> Novi bibliotekar
                    </a>
