                                        ...
                                        <span
                                            ...
                                            <div
                                                ...
                                                <a href="{{route('rentedBooks')}}" aria-label="Sve knjige"
                                                    ...
                                                    <div>
                                                        <p
                                                            class="transition duration-300 ease-in group-hover:text-[#576cdf] text-[#576cdf] text-xs 2xl:text-[15px] ml-[18px]">
                                                            Izdate knjige
                                                        </p>
                                                    </div>
                                                </a>
                                        ...
                                        <span
                                            ...
                                            <div
                                                ...
                                                <a href="{{route('returnedBooks')}}" aria-label="Izdate knjige"
                                                    ...
                                                    <div>
                                                        <p
                                                            class="text-xs 2xl:text-[15px] ml-[21px] transition duration-300 ease-in group-hover:text-[#576cdf]">
                                                            Vraćene knjige</p>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <table class="w-full shadow-lg" id="myTable">
                                    <thead class="bg-[#EFF3F6]">
                                        <form action="/filterRentedBooks" method="GET">
                                            ...
                                            <th
                                                class="relative px-2 py-4 text-xs leading-4 tracking-wider text-left 2xl:text-sm xl:px-4 whitespace-nowrap">
                                        ...
                                        @foreach($rented as $rent)
                                            ...
                                            <td class="flex flex-row items-center px-2 py-4 xl:px-4 whitespace-nowrap">
                                                @if(count($rent->book->coverImage) > 0 )
                                                    <img class="object-cover w-8 h-10 mr-4" src="/storage/image/{{$rent->book->coverImage[0]->photo}}" alt="" />
                                                @endif
                                                <a href="{{route('rentDetails', ['book' => $rent->book, 'student' => $rent->student])}}">
                                                    <span class="text-xs font-medium text-center 2xl:text-sm">{{$rent->book->title}}</span>
                                                </a>
                                            </td>
                                            <td class="px-2 py-4 leading-5 xl:px-4 whitespace-nowrap">
                                                <a href="{{route('studentProfile', ['user' => $rent->student])}}" class="text-xs 2xl:text-sm">
                                                    {{$rent->student->name}}
                                                </a>
                                            </td>
                                            <td class="px-2 py-4 text-xs leading-5 2xl:text-sm xl:px-4 whitespace-nowrap">{{$rent->rent_date}}</td>
                                            <td class="py-4 px-2 leading-5 xl:px-4 truncate max-w-[140px] 2xl:max-w-[300px]">
                                                <div>
                                                    <span class="text-xs 2xl:text-sm">{{ \Carbon\Carbon::parse($rent->rent_date)->diffAsCarbonInterval() }}</span>
                                                </div>
                                            </td>
                                            <td class="px-2 py-4 leading-5 xl:px-4 whitespace-nowrap">
                                                <a href="{{route('librarianProfile', ['user' => $rent->librarian])}}" class="text-xs 2xl:text-sm">
                                                    {{$rent->librarian->name}}
                                            ...
                                            <td class="px-2 py-4 leading-5 text-right xl:px-4">
                                                <p
                                                    class="inline cursor-pointer text-[20px] py-[10px] px-[10px] 2xl:px-[30px] border-gray-300 dotsRentedBooks hover:text-[#606FC7]">
