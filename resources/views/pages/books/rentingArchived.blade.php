    ...
    <div class="w-[80%]">
            ...
            <div class="w-full mt-[10px] ml-2 px-4">
                <table class="w-full shadow-lg" id="myTable">
                    ...
                    <tr class="border-b-[1px] border-[#e4dfdf]">
                        ...
                        <th class="relative px-2 py-4 text-xs leading-4 tracking-wider text-left cursor-pointer 2xl:text-sm xl:px-4 whitespace-nowrap">Datum rezervacije<i class="ml-2 fas fa-filter dateDrop-toggle"></i>
                            <div id="dateDropdown"
                        ...
                        <th class="relative px-2 py-4 text-xs leading-4 tracking-wider text-left cursor-pointer 2xl:text-sm xl:px-4 whitespace-nowrap">Rezervacija ističe<i class="ml-2 fas fa-filter delayDrop-toggle"></i>
                        ...
                        <th class="relative px-2 py-4 text-xs leading-4 tracking-wider text-left cursor-pointer 2xl:text-sm xl:px-4 whitespace-nowrap">Rezervaciju podnio<i class="ml-2 fas fa-filter studentsDrop-toggle"></i>
                        ...
                        <th class="relative px-2 py-4 text-xs leading-4 tracking-wider text-left cursor-pointer 2xl:text-sm xl:px-4 whitespace-nowrap">Status<i class="ml-2 fas fa-filter statusDrop-toggle"></i>
                    ...
                    @foreach($rentingArchived as $rentingArchive)
                        ...
                        <td class="px-2 py-4 text-xs leading-5 2xl:text-sm xl:px-4 whitespace-nowrap">{{$rentingArchive->reservation_date}}</td>
                        <td class="px-2 py-4 text-xs leading-5 2xl:text-sm xl:px-4 whitespace-nowrap">{{$rentingArchive->reservation_date->addDays(20)}}</td>
                        <td class="flex flex-row items-center px-2 py-4 xl:px-4 whitespace-nowrap">
                            <img class="object-cover w-8 h-10 mr-4 rounded-full" src="/storage/image/{{$rentingArchive->student->photo}}"
                                alt="" />
                            <a href="{{route('studentProfile',['user' => $rentingArchive->student->id])}}" class="text-xs font-medium text-center 2xl:text-sm">{{$rentingArchive->student->name}}</a>
                        </td>
                        <td class="px-2 py-4 leading-5 text-blue-900 xl:px-4 whitespace-nowrap">
                            @if($rentingArchive->closeReservation_id == 1)
                                <div
                                    class="inline-block px-[6px] py-[2px] font-medium bg-yellow-200 rounded-[10px]">
                                    <span class="text-xs text-yellow-700 2xl:text-sm">
                                        Istekla
                                    </span>
                                </div>
                            @elseif($rentingArchive->closeReservation_id == 2)
                                <div
                            ...
                            @elseif($rentingArchive->closeReservation_id == 3)
                                <div
                                    class="inline-block px-[6px] py-[2px] font-medium bg-red-200 rounded-[10px]">
                                    <span class="text-xs text-red-800 2xl:text-sm">
                                        Otkazana
                            ...
                            @elseif($rentingArchive->closeReservation_id == 4)
                                <div
                                    class="inline-block px-[6px] py-[2px] font-medium bg-green-200 rounded-[10px]">
                                    <span class="text-xs text-green-800 2xl:text-sm">
                                        Izdata
                                    </span>
                                </div>
                            @elseif($rentingArchive->closeReservation_id == 5)
                                <div
                                    class="inline-block px-[6px] py-[2px] font-medium bg-green-200 rounded-[10px]">
                                    <span class="text-xs text-green-800 2xl:text-sm">
                                        Rezervisana
                        ...
                        <td class="px-2 py-4 text-sm leading-5 text-right xl:px-4">
                            <p
                                class="inline cursor-pointer text-[20px] py-[10px] px-[10px] 2xl:px-[30px] border-gray-300 dotsRentingArchivedReservationsTable hover:text-[#606FC7]">
                                <i class="fas fa-ellipsis-v"></i>
                            </p>
                            <div
                                class="relative z-10 hidden transition-all duration-300 origin-top-right transform scale-95 -translate-y-2 renting-archived-reservations">
                                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                    aria-labelledby="headlessui-menu-button-1"
                                    id="headlessui-menu-items-117" role="menu">
                                    <div class="py-1">
                                        <a href="{{route('rentDetails',['book'=>$rentingArchive->book,'student'=>$rentingArchive->student])}}" tabindex="0"
        ...
        @else
            <div class="mx-[40px] flex items-center px-6 py-4 my-4 text-lg bg-red-200 rounded-lg">
                ...
                <p class="font-medium text-red-600"> Knjiga {{$book->title}} nema arhiviranih rezervacija! </p>
            </div>
        @endif
            <!--Modal-->
            <div
