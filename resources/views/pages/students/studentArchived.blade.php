            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <p
                            class="inline cursor-pointer text-[25px] py-[10px] pl-[30px] border-l-[1px] border-gray-300 dotsStudentBooksArchived hover:text-[#606FC7]">
                            <i class="fas fa-ellipsis-v"></i>
                        </p>
                        <div
                            class="z-10 hidden transition-all duration-300 origin-top-right transform scale-95 -translate-y-2 student-archived-books">
                        ...
                        <table class="w-full shadow-lg" id="myTable">
                            <thead class="bg-[#EFF3F6]">
                                <tr class="border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <th class="flex items-center px-2 py-4 text-xs leading-4 tracking-wider text-left xl:px-4 whitespace-nowrap 2xl:text-sm">Naziv
                            ...
                            @foreach($archivedReservations as $archivedReservation)
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="flex flex-row items-center px-2 py-4 xl:px-4 whitespace-nowrap">
                                        ...
                                        @endif
                                        <a href="{{route('bookDetails', ['book' => $archivedReservation->book])}}" class="text-xs 2xl:text-sm">
                                            <span class="text-xs font-medium text-center 2xl:text-sm">{{$archivedReservation->book->title}}</span>
                                        </a>
                                    </td>
                                    <td class="px-2 py-4 text-xs leading-5 xl:px-4 2xl:text-sm whitespace-nowrap">{{$archivedReservation->reservation_date}}</td>
                                    <td class="px-2 py-4 text-xs leading-5 xl:px-4 2xl:text-sm whitespace-nowrap">{{$archivedReservation->reservation_date->addDays(20)}}</td>
                                    <td class="flex flex-row items-center px-2 py-4 xl:px-4 whitespace-nowrap">
                                        <img class="object-cover w-8 h-10 mr-4 rounded-full" src="/storage/image/{{$archivedReservation->student->photo}}"
                                            alt="" />
                                        <a href="{{route('studentProfile', ['user' => $archivedReservation->student])}}" class="text-xs font-medium text-center 2xl:text-sm">{{$archivedReservation->student->name}}</a>
                                    </td>
                                    <td class="px-2 py-4 leading-5 text-blue-900 xl:px-4 whitespace-nowrap">
                                            @if($archivedReservation->closeReservation_id == 1)
                                                <div
                                                    ...
                                                    <span class="text-xs text-red-700 2xl:text-sm">
                                                        Istekla
                                                    </span>
                                                </div>
                                            ...
                                            @elseif($archivedReservation->closeReservation_id == 4)
                                                <div
                                                    ...
                                                    <span class="text-xs text-yellow-800 2xl:text-sm">
                                                        Izdata
                                                    </span>
                                                </div>
                                    ...
                                    <td class="px-2 py-4 leading-5 text-right xl:px-4">
                                        <p
                                            class="inline cursor-pointer text-[20px] py-[10px] px-[10px] 2xl:px-[30px] border-gray-300 dotsStudentArchivedBooks hover:text-[#606FC7]">
                                            <i class="fas fa-ellipsis-v"></i>
                                        </p>
                                        <div
                                            class="relative z-10 hidden transition-all duration-300 origin-top-right transform scale-95 -translate-y-2 student-archived-books-table">
